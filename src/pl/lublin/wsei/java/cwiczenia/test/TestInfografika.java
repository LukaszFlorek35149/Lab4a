...
public class TestInfografika {
    public static void main(String[] args) {
        String tekstInfografika="<item>\n" +
                ...
                "\t\t</item>";
        Infografika test = new Infografika(tekstInfografika);
        ...
        System.out.println("rozmiary: "+test.szerokosc.toString()+"x"+test.wysokosc.toString());
    }
}
